        ...
        <div className='w-full lg:w-2/3 px-5 lg:px-10 py-10'>
          <div className='flex justify-between border-b pb-8'>
            ...
            <span className='rounded-full bg-brand text-white px-2 py-1 text-xs font-bold flex items-center'>
              {cart ? cart?.cartItems?.reduce((acc, item) => acc + item.amount, 0) : 0} Items
            </span>
          </div>
                ...
                <div className='flex w-2/5'>
                  ...
                  <div className='flex flex-col justify-between ml-4 flex-grow'>
                    ...
                    <p className='text-xs flex items-center'>
                      Color <span className='ml-2'>{item.color.name}</span>
                    </p>
                    <p className='text-xs flex items-center'>
                      Size <span className='ml-2'>{item.size.name}</span>
                    </p>
          ...
          <Link to={from} className='flex font-semibold text-brand text-sm mt-10 hover:underline'>
        ...
        <div id='summary' className='w-full lg:w-1/3 px-5 lg:px-10 py-10'>
          ...
          <div>
            ...
            <select className='block p-2 text-gray-600 w-full' onChange={(e) => setPromo(e.target.value)}>
              <option value='10000'>Standard shipping - 10K</option>
            </select>
          </div>
          <div className='py-10'>
            ...
            <div className='flex items-center'>
              ...
              />
              <button className='bg-gray-500 hover:bg-gray-600 p-3 text-sm text-white w-1/3'>APPLY</button>
            </div>
          </div>
          ...
          <div className='border-t mt-8'>
            ...
            <button className='bg-brand-dark hover:bg-brand-darker py-3 text-white w-full'>CHECKOUT</button>
          </div>
        </div>
      </div>
    </div>
